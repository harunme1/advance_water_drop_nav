        ...
        home: Scaffold(
          bottomNavigationBar: WaterDropNavBar(barItems: <BarItem>[
            BarItem(
                ...
                outlinedIcon: Icons.home_outlined,  btext: "Home"),
            BarItem(
                filledIcon: Icons.bookmark_rounded,
                outlinedIcon: Icons.bookmark_outline_rounded,  btext: "Home")
    ...
    expect(() async {
      await tester.pumpWidget(boilerplate(<BarItem>[
        ...
        BarItem(
            ...
            outlinedIcon: Icons.favorite_border_rounded,  btext: "Home"),
        BarItem(
